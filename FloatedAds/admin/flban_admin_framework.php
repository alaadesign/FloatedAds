        ...
        jQuery(document).ready(function() {  
          function show_tab(li){
            if (!jQuery(li).hasClass("active_tab")){
              //hide all by_FloatedAds to change the whole panel animation style
              jQuery(".setingstab").css({'display':'none'}).animate({'opacity':'0'}, 50);
              jQuery(".panel_menu li").removeClass("active_tab");
              tab  = jQuery(li).find("a").attr("href");
              jQuery(li).addClass("active_tab");
              jQuery(tab).css({'display':'block'}).animate({'opacity':'1'}, 500);
          ...
          if (last_tab == null){
            ...
            jQuery(tab).css({'display':'block'}).animate({'opacity':'1'}, 1);
          }else{
